...
<head>
    ...
    <title>Login - SPK Jurusan Kuliah</title>
...
<body class="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 flex items-center justify-center p-4 font-inter">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-blue-200 text-sm mt-1">AHP & TOPSIS Decision Support System</p>
        </div>

        <!-- Card -->
        <div class="bg-white rounded-3xl shadow-2xl p-8">
            <h2 class="text-xl font-black text-gray-900 mb-1">Selamat Datang 👋</h2>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" required autofocus
                           ...
                           class="w-full px-4 py-3 border rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 {{ $errors->has('email') ? 'border-red-400 bg-red-50' : 'border-gray-200' }}"/>
                    @error('email')
                ...
                <div>
                    ...
                    <input type="password" id="password" name="password" required
                           placeholder="••••••••"
                           class="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 {{ $errors->has('password') ? 'border-red-400 bg-red-50' : '' }}"/>
                    @error('password')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <button type="submit" id="login-btn"
                        class="w-full py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-bold rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl mt-2">
                    Masuk ke Sistem
                </button>
            </form>
            ...
            <div class="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                <p class="text-blue-700 text-xs font-semibold mb-2">🔑 Demo Credentials:</p>
                <div class="grid grid-cols-2 gap-2 text-xs text-blue-600">
                    <div>
                        <p><strong>Admin:</strong></p>
                        <p>admin@spkjurusan.com</p>
                        <p>admin123</p>
                    </div>
                    <div>
                        <p><strong>User:</strong></p>
                        <p>user@spkjurusan.com</p>
                        <p>user1234</p>
                    </div>
                </div>
            </div>
