...
<div class="max-w-2xl mx-auto">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-blue-50">
            ...
            <p class="text-gray-500 text-sm mt-1">Masukkan data jurusan kuliah sebagai alternatif</p>
        </div>
        <form method="POST" action="{{ route('admin.alternatives.store') }}" class="p-6 space-y-5">
            @csrf
            <div>
                <label for="kode" class="block text-sm font-semibold text-gray-700 mb-2">Kode Jurusan <span class="text-red-500">*</span></label>
            ...
            <div>
                <label for="nama" class="block text-sm font-semibold text-gray-700 mb-2">Nama Jurusan <span class="text-red-500">*</span></label>
            ...
            <div>
                ...
                <textarea id="deskripsi" name="deskripsi" rows="3"
                          ...
                          class="w-full px-4 py-2.5 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-blue-500 resize-none">{{ old('deskripsi') }}</textarea>
            </div>
            <div class="flex items-center space-x-3 p-4 bg-gray-50 rounded-xl">
                ...
                <label for="active" class="text-sm font-medium text-gray-700">Jurusan aktif (akan disertakan dalam perhitungan)</label>
            </div>
